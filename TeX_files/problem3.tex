...
\begin{figure}[H] 
	\centering
	\includegraphics[scale=0.65]{A_bends}
	\caption{3D far field radiation pattern.}
	\label{fig:A_bend1}
\end{figure}
...
\begin{figure}[H] 
	\centering
	\includegraphics[scale=0.45]{A_bends2}
	\caption{3D far field radiation pattern.}
	\label{fig:A_bend}
\end{figure}
...
\begin{figure}[H] 
	\centering
	\subfloat[][\emph{3dB splitter}]{\includegraphics[scale=.4]{A_3dBT}}\quad
	\subfloat[][\emph{5.3dB splitter}]{\includegraphics[scale=.35]{A_5dBT}}\\
